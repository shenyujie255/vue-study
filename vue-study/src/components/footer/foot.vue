<template>
  <div class="foot_container">
      ...
      <section class="end_item" @click = "gotoAddress({path:'/miste', query: {geohash}})">
        <svg class="icon_style">
            <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('miste') !== -1? '#misteActive' : '#msite'"></use>
        </svg>
        <span>外卖</span>
      </section>
