<template>
    <div :id="id" style="width:356px;height:280px;">
    </div>
</template>
                ...
                series:[
                    {
                        name: '访问来源',
                        type: 'pie',         //饼图
                        radius: '50%',  //外半径为可视区尺寸（容器高宽中较小一项）的 50% 长度
                        center: ['50%', '60%'], //设置成百分比时第一项是相对于容器宽度，第二项是相对于容器高度
                        data: series_data,
                        itemStyle: {
                            emphasis: {     //图形的高亮样式
                                shadowBlur: 10,
                                shadowOffsetX: 0,
                                shadowColor: 'rgba(0, 0, 0, 0.5)'       //图形的阴影效果
                            }
                        }
                    }
                ]
