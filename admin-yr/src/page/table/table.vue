  ...
  <div class="table_box">
    ...
    <div class="table_content">
      ...
      <div class="operate">
          ...
          <el-input v-model="search_input" placeholder="请输入内容" prefix-icon="el-icon-search" class="select_input">
          </el-input>
    ...
    <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
      ...
      <!-- 删除弹出框 -->
    <el-dialog title="编辑" :visible.sync="deltVisible" width="30%">
      <div class="del-dialog-cnt">删除不可恢复，是否确定删除？</div>
      <span slot="footer" class="dialog-footer">
          <el-button @click="deltVisible = false">取 消</el-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        del_list: [],    //删除的数组
        editVisible: false,  // 弹出框状态
        deltVisible: false,  //flase不显示  
        form: {           // 编辑form
            name: '',
            date: '',
            address: ''
        ...
        return this.tableData.filter((d) => {
            ...
            if (!is_del) {
                if (d.address.indexOf(this.select_cate) > -1 &&
                      (d.name.indexOf(this.search_input) > -1 ||
                        d.address.indexOf(this.search_input) > -1)
                ) {
                    return d;
                }
            }
